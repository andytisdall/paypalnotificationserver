...
export const submitMealSurveyDataV3 = async (data: MealSurveyArgsV3) => {
  ...
  const surveyData: MealSurveyDataV3 = {
    ...
    Food_American__c: data.favorites.American[0],
    Food_Asian__c: data.favorites["Asian Cuisine"][0],
    Food_BBQ__c: data.favorites.Barbecue[0],
    Food_Italian__c: data.favorites.Italian[0],
    Food_Mexican__c: data.favorites.Mexican[0],
    Food_Sandwiches__c: data.favorites.Sandwiches[0],
    Food_Southern__c: data.favorites["Southern/ Soul"][0],
