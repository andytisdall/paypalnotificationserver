...
paypalRouter.post('/paypal', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, fetcher_1.default.instance.post(recurringInsertUri, recurringToAdd)];
            case 1:
                response = _a.sent();
                summaryMessage = {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, fetcher_1.default.instance.patch(recurringUpdateUri, recurringToUpdate)];
            case 2:
                response = _a.sent();
                summaryMessage = {
                    success: response.data.success,
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, fetcher_1.default.instance.get(oppQueryUri)];
            case 1:
                ...
                return [4 /*yield*/, fetcher_1.default.instance.patch(oppUpdateUri, oppToUpdate)];
            case 2:
                response = _a.sent();
                summaryMessage = {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, fetcher_1.default.instance.post(oppInsertUri, oppToAdd)];
            case 1:
                response = _a.sent();
                summaryMessage = {
                    success: response.data.success,
