    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.sent();
                    return [4 /*yield*/, fetcher_1.default.instance.get(urls_1.default.SFOperationPrefix + '/GW_Volunteers__Volunteer_Shift__c/' + shiftId)];
                case 2:
                    data = (_c.sent()).data;
                    ...
                    return [4 /*yield*/, fetcher_1.default.instance.post(hoursInsertUri, hoursToAdd)];
                case 3:
                    insertRes = _c.sent();
                    if (!((_b = insertRes.data) === null || _b === void 0 ? void 0 : _b.success)) return [3 /*break*/, 5];
                    return [4 /*yield*/, fetcher_1.default.instance.get(urls_1.default.SFOperationPrefix + '/Contact/' + contactId)];
                case 4:
                    res = _c.sent();
