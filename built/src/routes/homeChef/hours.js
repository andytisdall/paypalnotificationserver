    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                query = "SELECT Name, GW_Volunteers__Status__c, Number_of_Meals__c, GW_Volunteers__Shift_Start_Date_Time__c, GW_Volunteers__Volunteer_Job__c from GW_Volunteers__Volunteer_Hours__c WHERE GW_Volunteers__Contact__c = '" + id + "'";
                hoursQueryUri = urls_1.default.SFQueryPrefix + encodeURIComponent(query);
                return [4 /*yield*/, fetcher_1.default.instance.get(hoursQueryUri)];
            case 2:
                response = _c.sent();
