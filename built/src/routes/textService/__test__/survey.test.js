...
it('submits a meal survey', function () { return __awaiter(void 0, void 0, void 0, function () {
...
it('submits a text signup survey', function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, supertest_1.default(index_1.default)
                    .post('/api/text/meal-survey')
