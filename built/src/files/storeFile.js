...
var validFileExtensions = ['.jpg', '.jpeg', '.png', '.heic'];
var convertFile = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var outputBuffer;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, heic_convert_1.default({
                    buffer: data,
                    format: 'JPEG',
                    quality: 0.2,
                })];
...
var storeFile = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var extension, data, fileName, storedFile, passthroughStream;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!(extension.toLowerCase() === '.heic')) return [3 /*break*/, 2];
                    return [4 /*yield*/, convertFile(file.data)];
                case 1:
                    data = _b.sent();
                    extension = '.jpeg';
                    _b.label = 2;
                case 2:
                    ...
                    storedFile = bucket_1.bucket.file(name + extension);
                    passthroughStream = new stream_1.default.PassThrough();
                    ...
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            ...
                            passthroughStream.on('finish', function () { return resolve(fileName); });
                        })];
            }
        });
    });
