...
var getAccountForFileUpload = function (accountType, accountId) { return __awaiter(void 0, void 0, void 0, function () {
    var restaurant, user, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(accountType === 'restaurant')) return [3 /*break*/, 2];
                return [4 /*yield*/, Restaurant.findById(accountId)];
            case 1:
                restaurant = _a.sent();
                if (!restaurant) {
            ...
            case 2:
                if (!(accountType === 'contact')) return [3 /*break*/, 6];
            ...
            case 4:
                _a.sent();
                return [4 /*yield*/, fetcher_1.default.instance.get(urls_1.default.SFOperationPrefix + '/Contact/' + user.salesforceId)];
            case 5:
                data = (_a.sent()).data;
                if (!(data === null || data === void 0 ? void 0 : data.LastName) || !data.npsp__HHId__c) {
...
exports.getAccountForFileUpload = getAccountForFileUpload;
