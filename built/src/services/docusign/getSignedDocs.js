    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, fetcher_1.default.instance.get(urls_1.default.docusign + "/v2/accounts/" + DOCUSIGN_ACCOUNT_ID + "/envelopes/" + envelopeId + "/documents/combined", { headers: headers, responseType: 'arraybuffer', responseEncoding: 'binary' })];
            case 3:
                docs = _a.sent();
