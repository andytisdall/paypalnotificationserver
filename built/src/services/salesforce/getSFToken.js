...
exports.default = (function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, SF_CLIENT_ID, SF_CLIENT_SECRET, SFAuthPost, SF_AUTH_URI, SFResponse;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), SF_CLIENT_ID = _a.SF_CLIENT_ID, SF_CLIENT_SECRET = _a.SF_CLIENT_SECRET;
                if (!SF_CLIENT_ID || !SF_CLIENT_SECRET) {
                    throw new Error('Could not find salesforce auth credentials');
                }
                SFAuthPost = new URLSearchParams();
